...
if(isset($_POST['start'])) {
    ...
    if(mysqli_num_rows($res) > 0) {
        ...
        while($row = mysqli_fetch_assoc($res) ) {
                $sno = $row["sno"];
                $id = "three-dots$sno";
                $html .= '<div class="video d-flex justify-content-center">
                <video controls width="320">
                    <source src="./uploads/mov_bbb.mp4" type="video/mp4">
                </video>
            </div>
            <div class="collapse" id=' . $id . '>
                <div class="card card-body mx-auto" style="width: 320px;">
                    Some placeholder content for the collapse component. This panel is hidden by default but revealed when the user activates teh relevant trigger. </div>
            </div>
            <div class="video-details d-flex justify-content-center mb-2">
